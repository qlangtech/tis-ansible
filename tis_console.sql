...
CREATE TABLE `application` (
  ...
  `full_build_cron_time` varchar(50) DEFAULT '',
  PRIMARY KEY (`app_id`),
...
CREATE TABLE `department` (
  `dpt_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'dpt_id',
...
CREATE TABLE `operation_log` (
  `op_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'op_id',
...
CREATE TABLE `resource_parameters` (
  ...
  `desc` varchar(200) DEFAULT NULL COMMENT 'key 描述',
...
CREATE TABLE `snapshot` (
  `sn_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'sn_id',
  `create_time` datetime NOT NULL COMMENT 'create_time',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'update_time',
...
CREATE TABLE `table_dump` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `datasource_table_id` int(11) NOT NULL,
...
CREATE TABLE `work_flow_build_history` (
  ...
  `trigger_type` tinyint(1) DEFAULT NULL ,
  ...
  `create_time` datetime DEFAULT NULL,
  `op_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `end_phase` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `work_flow_build_phase` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `work_flow_build_history_id` int(11) DEFAULT NULL,
...
CREATE TABLE `work_flow_publish_history` (
  ...
  `publish_reason` text CHARACTER SET utf8mb4 ,
